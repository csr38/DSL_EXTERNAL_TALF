...
public class GraphBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements GraphVisitor<T> {
	 ...
	 */
	@Override public T visitProgram(GraphParser.ProgramContext ctx) { return visitChildren(ctx); }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation returns the result of calling
	 ...
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitEdge_list(GraphParser.Edge_listContext ctx) { return visitChildren(ctx); }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation returns the result of calling
